...
import 'package:quraanapp/core/networking/audio_services.dart';
import 'package:quraanapp/features/quraan/home/logic/cubit/quraan_cubit.dart';
import 'package:quraanapp/features/quraan/home/logic/cubit/quraan_state.dart' as cubitState;
...
class _MushafScreenState extends State<MushafScreen> {
  ...
  void initState() {
    ...
    sub = audioService.currentAyahStream.listen((ayah) {
      ...
      state.maybeWhen(
        success: (data) {
          final ayahs = data.data.surahs.first.ayahs;
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            state.maybeWhen(
              success: (data) {
                audioService.playSurah(data.data.surahs.first.ayahs);
              },
              orElse: () {
