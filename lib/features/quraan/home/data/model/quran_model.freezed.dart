...
mixin _$Ayah {
 ...
 int get number; String get audio; List<String> get audioSecondary; String get text; int get numberInSurah; int get juz; int get manzil; int get page; int get ruku; int get hizbQuarter; dynamic get sajda;
...
@useResult
$Res call({
 int number, String audio, List<String> audioSecondary, String text, int numberInSurah, int juz, int manzil, int page, int ruku, int hizbQuarter, dynamic sajda
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int number,  String audio,  List<String> audioSecondary,  String text,  int numberInSurah,  int juz,  int manzil,  int page,  int ruku,  int hizbQuarter,  dynamic sajda)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ayah() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int number,  String audio,  List<String> audioSecondary,  String text,  int numberInSurah,  int juz,  int manzil,  int page,  int ruku,  int hizbQuarter,  dynamic sajda)  $default,) {final _that = this;
switch (_that) {
case _Ayah():
return $default(_that.number,_that.audio,_that.audioSecondary,_that.text,_that.numberInSurah,_that.juz,_that.manzil,_that.page,_that.ruku,_that.hizbQuarter,_that.sajda);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int number,  String audio,  List<String> audioSecondary,  String text,  int numberInSurah,  int juz,  int manzil,  int page,  int ruku,  int hizbQuarter,  dynamic sajda)?  $default,) {final _that = this;
switch (_that) {
case _Ayah() when $default != null:
return $default(_that.number,_that.audio,_that.audioSecondary,_that.text,_that.numberInSurah,_that.juz,_that.manzil,_that.page,_that.ruku,_that.hizbQuarter,_that.sajda);case _:
  return null;
